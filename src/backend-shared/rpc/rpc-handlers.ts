...
export function createHandlers(
	...
	const sessionManager = new SessionManager(cm, db, (connectionId, database, sessionId) => {
		queryExecutor.sessionLog.resetPendingCount(connectionId, database, sessionId)
	})
