import type { ConnectionConfig, ConnectionInfo, ConnectionState, PostgresConnectionConfig } from '../../shared/types/connection'
import { CONNECTION_TYPE_META, getDefaultDatabase, isServerConfig } from '../../shared/types/connection'
