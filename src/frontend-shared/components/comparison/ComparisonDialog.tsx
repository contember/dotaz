...
import type { SchemaData, ColumnInfo } from "../../../shared/types/database";
...
interface ComparisonDialogProps {
	open: boolean;
	onClose: () => void;
	onCompare: (left: ComparisonSource, right: ComparisonSource, keyColumns: ComparisonColumnMapping[], columnMappings: ComparisonColumnMapping[]) => void;
...
export default function ComparisonDialog(props: ComparisonDialogProps) {
	...
	const connectedConnections = () =>
		connectionsStore.connections.filter((c: ConnectionInfo) => c.state === "connected");
