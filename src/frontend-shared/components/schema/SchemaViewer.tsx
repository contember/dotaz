...
export default function SchemaViewer(props: SchemaViewerProps) {
	const columns = createMemo<ColumnInfo[]>(() => connectionsStore.getColumns(props.connectionId, props.schema, props.table, props.database))
	const indexes = createMemo<IndexInfo[]>(() => connectionsStore.getIndexes(props.connectionId, props.schema, props.table, props.database))
