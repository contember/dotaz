...
import { decryptLocalPassword, encryptLocalPassword, isEncryptedPassword } from '@dotaz/backend-shared/services/encryption'
import { runMigrations } from './node-migrations'
...
export class NodeAppDatabase {
	...
	static create(dbPath: string): NodeAppDatabase {
		return new NodeAppDatabase(dbPath)
	}
